...
<head>
    ...
    <title>Uber for Errands - So you have time to do what you want to do!</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Uber For Errands</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>So
                            <strong>you have time to do what you want to do!</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">We work for you so you
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>We connect service requestors and providers instantaneously.</strong>
                    </h2>
                    <hr>
                    <p>If you have time and skills that others can use, you should join us as a Provider</p>
                    <p>If you don't have time and want people to do monotonous work for you, just Request a service and we'll be there in minutes </p>
                </div>
            </div>
        </div>
